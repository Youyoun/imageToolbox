# Implementations of https://openaccess.thecvf.com/content_CVPR_2020/papers/Zhang_Deblurring_by_Realistic_Blurring_CVPR_2020_paper.pdf
...
class RRDBNet(nn.Module):
    def __init__(
        ...
        self.model = sequential(
            fea_conv, ShortcutBlock_ZKH(sequential(*rb_blocks), LR_conv), HR_conv0, HR_conv1
        )
